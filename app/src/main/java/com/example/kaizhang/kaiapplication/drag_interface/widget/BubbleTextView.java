...
package com.example.kaizhang.kaiapplication.drag_interface.widget;
...
//        setTextSize(TypedValue.COMPLEX_UNIT_PX, grid.iconTextSizePx);
    ...
    public void applyFromShortcutInfo(CellInfo cellInfo) {
        FastBitmapDrawable iconDrawable = Utilities.createIconDrawable(((BitmapDrawable) cellInfo.getDrawable()).getBitmap());
        iconDrawable.setGhostModeEnabled(false);
        setCompoundDrawables(null, iconDrawable, null, null);
//            setCompoundDrawablePadding(grid.iconDrawablePaddingPx);
        setText(cellInfo.getFunctionInfo().getTitle());
        setTag(cellInfo);
    }
