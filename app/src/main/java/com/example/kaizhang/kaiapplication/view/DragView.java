...
import com.example.kaizhang.kaiapplication.utils.AnimUtils;
...
public class DragView extends View {
     ...
     * be centered upon.
     *
     * @param dragLayer     The dragLayer
     * @param bitmap        The view that we're dragging around.  We scale it up when we draw it.
     * @param registrationX The x coordinate of the registration point.
     * @param registrationY The y coordinate of the registration point.
     */
    public DragView(DragLayer dragLayer, Bitmap bitmap, int registrationX, int registrationY,
    ...
    public void crossFade(int duration) {
        ValueAnimator va = AnimUtils.ofFloat(this, 0f, 1f);
