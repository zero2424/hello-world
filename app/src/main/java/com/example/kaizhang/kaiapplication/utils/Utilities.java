...
public final class Utilities {
    ...
    public static ImageView getCloneView(Context context, View view) {
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(view.getLayoutParams());
        FrameLayout.LayoutParams originalLayoutParams = (FrameLayout.LayoutParams) view.getLayoutParams();
        layoutParams.setMargins(originalLayoutParams.leftMargin, originalLayoutParams.topMargin, originalLayoutParams.rightMargin, originalLayoutParams.bottomMargin);
